...
CultivarBatchFile<-"TMS14F1312P0003.CSC";
...
WorkDirectory<-getwd();
WorkDirectorySubstrings<-unlist(strsplit(WorkDirectory,"/DSSAT48GLUE67"));

DSSATD<-paste(WorkDirectorySubstrings[1],"/DSSAT48GLUE67", sep=""); #Get the working directory of DSSAT.

GLUED<-"/GLUE";#This one is the postion of GLUE under DSSAT and fixed by model developer.
OutputD<-"/DSSAT48GLUE67"; #This one is the position of DSSAT output and fixed by model developer.
GenotypeD<-"/DSSAT48GLUE67"; #This one is the position of Genotype file.
