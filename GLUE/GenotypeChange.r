...
GenotypeChange<-function(DSSATD, CropName, GenotypeFileName, CultivarID, TotalParameterNumber, RunNumber, RandomMatrix)
{
...
eval(parse(text=paste("NewGenotypeFilePath='",DSSATD,"/",GenotypeFileName,".CUL'",sep = '')));
