...
PosteriorDistribution<-function(WD, DSSATD, ParameterNames, ParameterProperty, CropName, RoundOfGLUE)
{
#Step 1. Read the saved parameter sets and their corresponding probabilities.
eval(parse(text = paste('RandomAndProbability<-read.table("',DSSATD,
...
eval(parse(text = paste('write.table(PosteriorDistribution,file ="',DSSATD,
